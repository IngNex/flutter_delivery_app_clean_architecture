...
class ApiRepositoryImpl extends ApiRepositoryInterface {
  ...
  Future<LoginResponse> login(LoginRequest login) async {
    ...
    try {
      UserCredential credential = await _auth.signInWithEmailAndPassword(email: login.username, password:  login.password);
  ...
  Future<List<Products>> getProducts(String token) async {
    ...
    return {HttpHeaders.authorizationHeader: 'Bearer $token',HttpHeaders.contentTypeHeader: 'application/json; charset=UTF-8'};
  }
